    ...
    if (!this.state.token) {
      return (
        <div className="login-panel">
          <div className="login-panel__div login-panel__div-col-all login-panel__div-head">
            Sign In
          </div>
          ...
          <div className="login-panel__div login-panel__div-col-2-3">
            <Link to="/signup" className="login-panel__signin">
              Sign Up
            </Link>
          </div>
        </div>
