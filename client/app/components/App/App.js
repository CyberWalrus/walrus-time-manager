      ...
      if (!this.state.isActive) {
        return (
          <div className="login-div">
            <Switch>
              <Route path="/login">
                <Login onChangeProp={this.handleActive.bind(this)} />
              </Route>
          ...
          <main className="base-div-main">
            <Switch>
              <PrivateRoute
                ...
                isRole={this.checkMenuRole(`/`)}
              />
              <PrivateRoute
                path="/helloworld"
                component={HelloWorld}
                isAuthenticated={this.state.isActive}
                isRole={this.checkMenuRole(`/helloworld`)}
              />
              <PrivateRoute
                path="/day"
                component={Day}
                isAuthenticated={this.state.isActive}
                isRole={this.checkMenuRole(`/day`)}
              />
              <PrivateRoute
                path="/options/menu"
                component={MenuOptions}
                isAuthenticated={this.state.isActive}
                isRole={this.checkMenuRole(`/options/menu`)}
              />
              <PrivateRoute
                path="/options/user"
                component={UserOptions}
                isAuthenticated={this.state.isActive}
                isRole={this.checkMenuRole(`/options/user`)}
              />
              <PrivateRoute
                path="/options/userrole"
                component={UserRoleOptions}
                isAuthenticated={this.state.isActive}
                isRole={this.checkMenuRole(`/options/userrole`)}
              />
              <PrivateRoute
                path="/message/:id"
                component={MessageManager}
                isAuthenticated={this.state.isActive}
                isRole={this.checkMenuRole(`/message`)}
              />
              <PrivateRoute
                path="/test"
                component={TestPage}
              ...
              <Route
                render={() =>
                  !this.state.isActive ? <Redirect to="/login" /> : <NotFound />
                }
              />
            </Switch>
          </main>
